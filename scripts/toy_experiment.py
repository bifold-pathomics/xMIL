...
from xmil.toy_experiments.datasets import get_number_mil_dataset, bag_collate_fn
from xmil.toy_experiments.scripts import train_model, evaluate_explanation
from xmil.toy_experiments.models import get_model_and_classifier, get_xmodel
...
def get_args():
    ...
    parser.add_argument(
        ...
        choices=["unique", "uniform", "hierarchical"],
    )
    parser.add_argument(
        "--features-type",
        type=str,
...
def main():
    ...
    data_loader_train = DataLoader(
        dataset_train, batch_size=args.batch_size, collate_fn=collate_fn
    )
    data_loader_val = DataLoader(
        dataset_val, batch_size=args.batch_size, collate_fn=collate_fn
    )
    ...
    for repetition in range(args.num_repetitions):
        ...
        for explanation_type in args.explanation_methods:
            ...
            test_metrics["auc"] = roc_auc_score(
